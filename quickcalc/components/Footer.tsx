        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 pb-10 border-b border-surface-border">
          ...
          <ScrollReveal delayMs={200} className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-ink-muted">
              ...
              <li>
                <Link href="/tools/solar-payback-calculator" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Solar ROI & Payback
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/tools/pakistan-income-tax-calculator" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Pakistan Income Tax (FBR)
                </Link>
              </li>
              <li>
                <Link href="/tools/pakistan-electricity-bill-calculator" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors font-medium text-emerald-600 dark:text-emerald-400">
                  Pakistan Electricity Bill (NEPRA)
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/tools/pakistan-vehicle-tax-calculator" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors font-medium text-blue-600 dark:text-blue-400">
                  Pakistan Vehicle Token Tax
                </Link>
              </li>
              <li>
                <Link href="/tools/pakistan-fuel-cost-calculator" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors font-medium text-emerald-600 dark:text-emerald-400">
                  Pakistan Fuel & Mileage (Petrol vs EV)
                </Link>
              </li>
              <li>
