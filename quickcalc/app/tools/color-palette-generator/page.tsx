...
export default function ColorPaletteGeneratorPage({ searchParams }: { searchParams?: { embed?: string } }) {
  const softwareSchema = generateSoftwareAppSchema({
    name: "Image Color Palette Generator - Free Hex Code Extractor",
    description: "Extract dominant colors from any image instantly. Get copy-to-click hex codes, CSS variables, Tailwind configurations, and WCAG accessibility contrast",
