          ...
          <section className="my-6 not-prose">
            <div className="p-5 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="space-y-1">
                <span className="text-xs font-bold text-amber-700 dark:text-amber-300 uppercase tracking-wider">Creator Business Guide</span>
                <h3 className="text-base font-bold text-zinc-900 dark:text-white">Etsy vs Amazon KDP: Complete Profit Comparison Guide</h3>
                <p className="text-xs text-zinc-600 dark:text-zinc-400">Discover side-by-side fee matrices, print-on-demand profit margins, customer ownership differences, and multi-channel publishing strategies.</p>
              </div>
              <Link
                href="/blog/etsy-vs-amazon-kdp-profit-comparison-guide"
