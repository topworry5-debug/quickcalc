...
export default function LoanCalculatorPage({ searchParams }: { searchParams?: { embed?: string } }) {
  const softwareSchema = generateSoftwareAppSchema({
    name: "Loan EMI Calculator - Free Amortization Schedule Tool",
    description: "Calculate your monthly loan EMI, total interest, and total payments. View a detailed year-by-year amortization schedule for home, auto, or personal lo",
