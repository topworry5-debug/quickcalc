...
export default function CurrencyConverterPage({ searchParams }: { searchParams?: { embed?: string } }) {
  const softwareSchema = generateSoftwareAppSchema({
    name: "Live Currency Converter - Convert 35+ World Exchange Rates",
    description: "Convert 35+ global currencies instantly with real-time exchange rates. Check USD to PKR, EUR to USD, and GBP to EUR conversion tables with no markup f",
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-[family-name:var(--font-geist-sans)] transition-colors">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        <EmbedWidget url="https://quickcalc.cloud/tools/currency-converter" title="Currency Converter" />
