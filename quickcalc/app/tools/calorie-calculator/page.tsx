...
export default function CalorieCalculatorPage({ searchParams }: { searchParams?: { embed?: string } }) {
  const softwareSchema = generateSoftwareAppSchema({
    name: "Calorie Calculator - TDEE & Daily Calorie Needs Finder",
    description: "Calculate your daily calorie needs using the scientific Mifflin-St Jeor formula. Get custom weight loss or muscle gain targets with no signup needed.",
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        <article className="prose prose-zinc dark:prose-invert max-w-3xl mx-auto space-y-8 mt-12 border-t border-zinc-200 dark:border-zinc-800 pt-10">
          <section className="space-y-4">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
              Combining your dietary profiles with our related health indicators like the <Link href="/tools/bmi-calculator" className="text-orange-600 dark:text-orange-400 hover:underline font-semibold">BMI Calculator</Link>, timing daily eating windows using our <Link href="/tools/intermittent-fasting-calculator" className="text-orange-600 dark:text-orange-400 hover:underline font-semibold">Intermittent Fasting Calculator</Link>, and mapping daily fluid requirements via the <Link href="/tools/water-intake-calculator" className="text-orange-600 dark:text-orange-400 hover:underline font-semibold">Water Intake Calculator</Link> lets you configure a highly cohesive, holistic physical wellness program without complex paywalls or email forms.
            </p>
          </section>
