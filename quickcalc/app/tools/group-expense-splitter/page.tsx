...
export default function GroupExpenseSplitterPage({ searchParams }: { searchParams?: { embed?: string } }) {
  const softwareSchema = generateSoftwareAppSchema({
    name: "Group Bill Splitter - Split Shared Expenses Unevenly",
    description: "Split group restaurant bills, travel costs, and rent unevenly by item. Assign custom splits, compute tax or tip proportionally, and copy breakdowns.",
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-[family-name:var(--font-geist-sans)] transition-colors">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8">
          ...
          <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">This free tool calculates itemized group bill splits, proportional tax and tip distribution, and debt simplification. Easily split group bills, restaurant orders, and shared travel costs unevenly based on itemized details. Add members, specify custom shares, and compute proportional tax and tips instantly.</p>
        </div>

        <ShareButtons url="https://quickcalc.cloud/tools/group-expense-splitter" title="Group Expense Splitter" />
        <EmbedWidget url="https://quickcalc.cloud/tools/group-expense-splitter" title="Group Expense Splitter" />
        ...
        <MethodologyAccordion slug="group-expense-splitter" />
        ...
        <RelatedTools currentSlug="group-expense-splitter" />
