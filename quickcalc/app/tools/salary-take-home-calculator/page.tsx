  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-[family-name:var(--font-geist-sans)] transition-colors">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        <MethodologyAccordion slug="salary-take-home-calculator" />
        ...
        <article className="prose prose-zinc dark:prose-invert max-w-3xl mx-auto space-y-8 mt-12 border-t border-zinc-200 dark:border-zinc-800 pt-10">
          <section className="space-y-4">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
              In Pakistan, salaried individuals are subject to progressive slabs defined annually by the Federal Board of Revenue (FBR). Unlike North American systems, Pakistan has fewer non-tax payroll deductions, placing the primary deduction emphasis almost entirely on direct income tax slabs. Since local and state taxes vary heavily, this calculator uses simplified national average rates to provide a rapid, clean overview without requiring complex provincial select boxes. If you need to compute weekly shift totals or overtime pay before taxes, check our free <Link href="/tools/work-hours-calculator" className="text-emerald-600 dark:text-emerald-400 font-semibold underline hover:text-emerald-700">Work Hours / Timesheet Calculator</Link>.
            </p>
          </section>
