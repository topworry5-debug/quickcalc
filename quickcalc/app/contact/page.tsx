...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-base text-ink font-sans transition-colors">
      {/* Navigation Header */}
      <Navbar />
      ...
      <main className="max-w-3xl mx-auto px-4 py-16 sm:py-20">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-ink font-heading mb-4">
            Get in Touch
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          {/* Email Card */}
          <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-surface-border text-center flex flex-col justify-between items-center">
            <div>
              ...
              <h2 className="text-lg font-bold text-ink font-heading mb-2">Email Us</h2>
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-medium text-sm transition shadow-sm"
            >
              topworry5@gmail.com
            </a>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-surface-border text-center flex flex-col justify-between items-center">
            <div>
              ...
              <h2 className="text-lg font-bold text-ink font-heading mb-2">Social Communities</h2>
              <p className="text-sm text-ink-muted mb-6">
                Follow us, track updates, and suggest features inside our open communities.
              </p>
            </div>
            <div className="flex gap-4">
              <span className="px-4 py-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-xs font-semibold text-ink-muted cursor-not-allowed">
                @QuickCalc (X)
              </span>
              <span className="px-4 py-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-xs font-semibold text-ink-muted cursor-not-allowed">
                GitHub Repository
