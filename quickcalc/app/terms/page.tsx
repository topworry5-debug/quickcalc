    ...
    <div className="min-h-screen bg-base text-ink font-sans transition-colors">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16 sm:py-20">
        <article className="prose prose-zinc dark:prose-invert max-w-none">
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-ink font-heading mb-6">
            Terms of Use
          </h1>
          <p className="text-xs text-ink-muted mb-8">Last Updated: July 9, 2026</p>
          ...
          <h2 className="text-xl font-bold text-ink font-heading mt-8 mb-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-ink-muted mb-6">
