...
export const toolOGData: Record<string, ToolOGData> = {
  ...
  "gfr-kidney-function-calculator": {
    name: "GFR / Kidney Function Calculator",
    tagline: "2021 CKD-EPI Race-Free Kidney Function Screener",
    example: "eGFR 94.1 mL/min/1.73m² → Stage 1 Normal ✓",
    gradient: ["#059669", "#0d9488"],
    accent: "#ecfdf5",
    category: "Health & Wellness",
  },
  "digital-storage-converter": {
    ...
    tagline: "Instant multi-unit data storage converter — binary & decimal",
    example: "1 TB → 1,000 GB (SI) | 931.32 GiB (Windows)",
  ...
  "speech-time-calculator": {
    ...
    tagline: "Convert script words to speech duration or target word counts",
    example: "500 words → 3 min 34 sec (140 WPM average pace)",
